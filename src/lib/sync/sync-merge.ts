...
// shared. Deliberately no CRDT machinery: recipes are rarely edited
// concurrently so whole-record last-write-wins is enough; grocery lists and
// meal plans merge their children (items/entries) by id instead, since those
// are additive/idempotent (checking an item, adding a slot) in a way a
// whole-record LWW would risk clobbering — see CLAUDE.md's "Sharing feature"
// roadmap item for the reasoning this mirrors.

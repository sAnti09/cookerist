...
describe("Meal plan detail screen — delete", () => {
	...
	it("hides the Share icon while the plan is still a draft", async () => {
	...
	it("hides the Share icon and labels delete as Remove for a plan shared to this account", async () => {
